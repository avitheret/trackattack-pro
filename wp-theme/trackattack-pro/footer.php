<footer>
  <div class="footer-inner">
    <a href="<?php echo esc_url( home_url('/') ); ?>" class="footer-logo">
      <img src="<?php echo tap_image('tap_footer_logo','Horizontal-logo-3to1-on-white-or-light-gray.png'); ?>" alt="Hoosier" style="height:40px;width:auto;opacity:0.7;">
    </a>
    <div class="social-icons">
      <a href="<?php echo esc_url( tap_text_raw('tap_fb','https://www.facebook.com/hoosiertire/') ); ?>" target="_blank" rel="noopener" aria-label="Facebook">
        <svg viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
      </a>
      <a href="<?php echo esc_url( tap_text_raw('tap_ig','https://www.instagram.com/HoosierTire/') ); ?>" target="_blank" rel="noopener" aria-label="Instagram">
      ...
      <a href="<?php echo esc_url( tap_text_raw('tap_yt','https://www.youtube.com/c/HoosierTire') ); ?>" target="_blank" rel="noopener" aria-label="YouTube">
  ...
  <div class="footer-bottom">
    <p><?php tap_text('tap_copyright','© Copyright Hoosier Racing Tire ' . date('Y')); ?></p>
